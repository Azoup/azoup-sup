/** Campos de status usados pela API Digisac (`User` do SDK). */
...
/**
 * Usuário Digisac que pode aparecer no mapeamento e nas métricas do dashboard.
 * Arquivados, excluídos, inativos e usuários de cliente ficam de fora.
 */
