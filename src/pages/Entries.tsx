        ...
        <CardContent>
          ...
          >
            ...
            <Select value={analystId} onValueChange={setAnalystId} required>
              <SelectTrigger>
                <SelectValue placeholder="Selecione analista" />
              </SelectTrigger>
              <SelectContent>
                {analysts.map((a) => (
            ...
            <Input type="number" placeholder="Qtd. dúvidas" min="1" value={quantity} onChange={(e) => setQuantity(e.target.value)} required />
